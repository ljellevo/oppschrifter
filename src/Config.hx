...
class Config {
  ...
  public static final API_AUTH: String = "/api/auth";
  public static final API_REGISTER: String = "/api/register";
  public static final API_LOGIN: String = "/api/login";
  public static final API_RECIPE_GET: String = "/api/recipe/";
  ...
  public static final API_RECIPE_GET: String = haxe.Resource.getString("url") + "/api/recipe/";
  public static final API_RECIPE_DELETE: String = haxe.Resource.getString("url") + "/api/recipe/";
