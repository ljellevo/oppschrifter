...
pages_RecipePage.prototype = $extend(com_vige_core_DynamicComponent.prototype,{
	...
	,isLink: function() {
		...
		if(this.data.getHasLink()) {
			...
			var this11 = Std.parseInt("0xff" + HxOverrides.substr("#CDCDCD",1,null));
			var tmp4 = new com_vige_utils_Shadow({ horizontal : "0px", vertical : "4px", blur : "6px", color : new com_vige_utils_Color({ backgroundColor : this11})});
			var this12 = Std.parseInt("0xff" + HxOverrides.substr("#CDCDCD",1,null));
			var tmp5 = [tmp4,new com_vige_utils_Shadow({ horizontal : "0px", vertical : "0px", blur : "2px", color : new com_vige_utils_Color({ backgroundColor : this12})})];
			...
			}, child : new com_vige_components_Container({ color : tmp2, size : tmp3, shadow : tmp5, padding : tmp6, child : new com_vige_components_Row({ flex : true, children : [new com_vige_components_Text("Til oppskrift",{ color : new com_vige_utils_Color({ color : this13}), textSize : 20})]})})})]})})});
		}
		return new com_vige_components_Container({ });
	}
	,generateSteps: function() {
