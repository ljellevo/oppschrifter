...
com_vige_components_Button.prototype = {
	...
	,render: function() {
		if(this.isLink) {
			...
			new com_vige_support_StyleManager().addStyleToAnchor({ widget : button, color : this.color, border : this.border, padding : this.padding, margin : this.margin, size : this.size, overflow : this.overflow});
			return button;
		} else {
			...
			new com_vige_support_StyleManager().addStyleToButton({ widget : button1, color : this.color, border : this.border, padding : this.padding, margin : this.margin, size : this.size, overflow : this.overflow});
			return button1;
		}
	}
...
com_vige_components_Center.prototype = {
	...
	,render: function() {
		...
		case 0:
			...
			new com_vige_support_StyleManager().addStyleToDiv({ widget : parent, color : this.color, border : this.border, padding : this.padding, margin : this.margin, size : new com_vige_utils_Size({ width : "100%"}), overflow : this.overflow});
		...
		case 1:
			...
			new com_vige_support_StyleManager().addStyleToDiv({ widget : parent, color : this.color, border : this.border, padding : this.padding, margin : this.margin, size : new com_vige_utils_Size({ height : "100%"}), overflow : this.overflow});
			element.appendChild(this.child.render());
