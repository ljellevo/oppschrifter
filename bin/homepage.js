...
components_CustomNavbar.prototype = $extend(com_vige_core_DynamicComponent.prototype,{
	homepageButton: function(text,src,url) {
		...
		return new com_vige_components_Button({ size : tmp, color : new com_vige_utils_Color({ color : -16777216, backgroundColor : this3}), border : determineBorder(), child : new com_vige_components_Row({ mainAxisAlignment : com_vige_support_MainAxisAlignment.Center, children : getButtonContents(text,src)}), onClick : function(e) {
